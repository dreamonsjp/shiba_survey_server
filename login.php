...
session_start();
    ...
    { 
        ...
        $query_check_credentials = "SELECT * FROM e_users WHERE (users_name='$Username' AND password='$sPasswordHash') AND activation IS NULL";
		...
		//echo @mysqli_num_rows($result_check_credentials);
